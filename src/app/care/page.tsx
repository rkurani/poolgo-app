  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] px-5 sm:px-10 pt-6 pb-32 md:pb-16 flex flex-col gap-10 sm:gap-14">
        ...
        {/* Connection ribbon — three live data sources feeding this surface */}
        <section className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <ConnectionChip
              ...
              alt="Leslie's"
              brand="Leslie's"
              role="Free water test, 2 days ago"
              tone="var(--color-source-imported)"
              softTone="var(--color-leslies-soft, #DEE8F7)"
              link="/connect"
            />
            <ConnectionChip
              ...
              alt="IntelliFlo3"
              brand="IntelliFlo3 + ORP probe"
              role="Live telemetry, 7 sec ago"
              tone="var(--color-source-live)"
              softTone="var(--color-pentair-soft, #E5ECF4)"
              link="/equipment/intelliflo3"
            />
            <ConnectionChip
              src="/assets/folks/carlos-portrait.png"
              alt="Carlos"
              brand="Carlos Mendoza"
              role="Weekly visit, 5 days ago"
              tone="var(--color-source-human)"
              softTone="#F8E2DD"
              link="/folks/carlos-redlands"
              isPortrait
            />
          </div>
        </section>
 ...
 */
/**
 * ConnectionChip: small horizontal card showing a data source plugged into
 * this surface. Real logo or pixel portrait, brand-stripe at top, green
 * "connected" dot, last-sync timestamp, and a link to the source.
 */
function ConnectionChip({
  ...
  return (
    <Link
      href={link}
      className="group relative rounded-xl border-2 pl-2 pr-4 py-2 flex items-center gap-3 shadow-[3px_3px_0_0_rgba(59,52,42,0.18)] hover:translate-y-[-2px] transition-transform overflow-hidden"
      style={{
        backgroundColor: "var(--color-data-cream, #F1E6D3)",
        borderColor: "var(--color-mountain-shadow, #5C5546)",
      }}
    >
      ...
      />
      <div
        className="relative h-12 w-12 shrink-0 rounded-md border overflow-hidden grid place-items-center mt-1"
        style={{
          borderColor: "var(--color-mountain-shadow, #5C5546)",
      ...
      <div className="flex flex-col gap-0.5 flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          <span
            ...
            aria-hidden
          />
          <span className="font-pixel text-[8px] uppercase tracking-[0.12em]"
                style={{ color: "var(--color-source-live)" }}>
            connected
          </span>
        </div>
        <span className="text-[13px] font-extrabold tracking-[-0.005em] truncate"
              style={{ color: "var(--color-data-ink, #3B342A)" }}>
          {brand}
        </span>
